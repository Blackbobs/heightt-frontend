...
export function BottomNav() {
  ...
  return (
    <nav className="lg:hidden flex justify-around items-center py-2.5 px-4 pb-[max(0.625rem,env(safe-area-inset-bottom))] bg-white border-t border-[#e8ecf1] flex-shrink-0">
