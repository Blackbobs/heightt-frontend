  ...
  return (
    <div ref={wrapperRef} className="perspective-1000 relative w-full flex justify-center items-center py-2">
      ...
      <div className="hidden sm:flex absolute -top-3 -left-4 lg:-left-8 z-30 bg-white/95 backdrop-blur-xl border border-slate-200/80 p-2.5 rounded-2xl shadow-[0_16px_36px_rgba(0,0,0,0.1)] items-center gap-2.5 animate-float-slow">
        ...
        <div>
          <div className="flex items-center gap-1.5">
            <span className="text-xs font-bold text-[#0B1020]">Payment Verified</span>
            <span className="text-[9px] text-emerald-700 font-bold bg-emerald-100 px-1.5 py-0.2 rounded-full">Live</span>
          </div>
          <p className="text-[10.5px] text-[#64748B]">Receipt #HT-84920 auto-generated</p>
        </div>
      </div>
      ...
      >
        ...
        {/* Screen Container */}
        <div className="w-full h-full bg-[#F8FAFC] rounded-[34px] overflow-hidden flex flex-col justify-between text-foreground relative shadow-inner">
          ...
          <div className="px-3.5 pt-2 pb-1.5 bg-white/95 backdrop-blur-md border-b border-slate-200/80 shrink-0 z-20">
            {/* Status Bar */}
            <div className="flex justify-between items-center pb-1 text-[9.5px] font-bold text-[#0B1020]">
              <span>{time}</span>
              <div className="flex items-center gap-1 text-[#0B1020]">
            ...
            <div className="flex items-center justify-between gap-1.5 pt-0.5">
              <div className="min-w-0">
                <p className="text-[12px] font-bold text-[#0B1020] leading-tight truncate">
                  Good morning, <span className="text-[#2563EB]">Ayodeji</span>
                </p>
                <p className="text-[9px] text-[#64748B] truncate">What do you need to pay right now?</p>
              </div>
              <div className="relative w-6 h-6 rounded-full bg-slate-100 border border-slate-200 flex items-center justify-center text-[#0B1020] shrink-0">
            ...
            <div className="mt-1.5 flex items-center justify-between bg-[#f0f4ff] border border-[#2563EB]/20 px-2 py-1 rounded-lg text-[10px]">
              <div className="flex items-center gap-1 text-[#0B1020] font-semibold truncate">
          ...
          <div className="flex-1 flex flex-col justify-between px-3 py-2 space-y-1.5 overflow-hidden">
            ...
            <div className="grid grid-cols-2 gap-1.5 shrink-0">
              ...
              <div className="bg-white rounded-xl p-2 border border-slate-200/80 shadow-xs">
                <div className="flex items-center justify-between mb-0.5">
                  <span className="text-[8.5px] font-bold text-[#64748B] uppercase flex items-center gap-0.5">
                ...
                <div className="text-[13px] font-extrabold text-[#0B1020] leading-tight">₦12,500</div>
                <div className="text-[8px] text-[#2563EB] font-semibold mt-0.5">Receipts ready →</div>
              </div>
              ...
              <div className="bg-white rounded-xl p-2 border border-slate-200/80 shadow-xs">
                ...
                <div className="text-[13px] font-extrabold text-[#0B1020] leading-tight">₦8,000</div>
            ...
            <div className="bg-white rounded-xl p-2 border border-slate-200/80 shadow-xs shrink-0">
              <div className="flex items-center justify-between mb-1">
                <span className="text-[9.5px] font-bold text-[#0B1020] flex items-center gap-1">
                  <span>Dues Pending</span>
                  <span className="text-[7.5px] bg-amber-100 text-amber-800 font-bold px-1 rounded-full">1</span>
                </span>
                <span className="text-[8.5px] font-semibold text-[#2563EB]">View all</span>
              </div>

              <div className="p-1.5 rounded-lg bg-[#F8FAFC] border border-slate-200/60 flex items-center justify-between gap-1.5">
                <div className="min-w-0">
                  <p className="text-[9.5px] font-bold text-[#0B1020] truncate">Faculty Development Levy</p>
                  <p className="text-[8px] text-[#64748B] truncate">Faculty of Physical Sciences</p>
                  <p className="text-[9.5px] font-extrabold text-[#0B1020]">₦8,000</p>
                </div>
                <button
                  type="button"
                  className="bg-[#2563EB] hover:bg-[#124bda] text-white text-[9px] font-bold px-2.5 py-1 rounded-md shadow-xs shrink-0 flex items-center gap-0.5 cursor-pointer"
                >
            ...
            <div className="bg-white rounded-xl p-2 border border-slate-200/80 shadow-xs shrink-0">
              <div className="flex items-center justify-between mb-1">
                <span className="text-[9.5px] font-bold text-[#0B1020]">Recent Payment Receipts</span>
                <span className="text-[8.5px] font-semibold text-[#2563EB]">All (2)</span>
              </div>

              <div className="p-1.5 rounded-lg bg-[#f0fdf4] border border-emerald-200/60 flex items-center justify-between gap-1.5">
                <div className="min-w-0">
                  <div className="flex items-center gap-1">
                    <p className="text-[9.5px] font-bold text-[#0B1020] truncate">Departmental Annual Dues</p>
            ...
            <div className="py-1 px-2 rounded-lg bg-[#EFF6FF] border border-[#2563EB]/20 flex items-center justify-between text-[8.5px] text-[#2563EB] font-semibold shrink-0">
          ...
          <div className="bg-white/95 backdrop-blur-md border-t border-slate-200/90 py-1.5 px-3 flex justify-around items-center shrink-0 z-20">
            ...
            <div className="flex flex-col items-center gap-0.5 text-[#64748B]">
